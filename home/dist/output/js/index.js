...
var slider=(function(){
	...
	EventUtil.addHandler(document.querySelector('.slider_b'),'click',handerSlider);	
	//EventUtil.addHandler(document.querySelector('.slider_b'),'mouseout',sliderModule.mouseoutHandler);
	//监听鼠标滑动到导航页
